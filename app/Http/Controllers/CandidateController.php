...
class CandidateController extends Controller
{
    ...
    public function store(HttpRequest $request)
    {
        ...
        $this->logActivity('created', $candidate, null, $candidate->toArray());
    ...
    public function show($id)
    {
        ...
        $this->logActivity('viewed', $candidate, null, null);
    ...
    public function match($id)
    {
        ...
        $this->logActivity('matched', $candidate, null, ['match_score' => $candidate->match_score]);
